<template>
    <div class="relative pb-4">
        ...
        <p class="text-red-600 text-sm" v-text="errorMessage()" :class="errorClassObject()">Error Here</p>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            clearErrors: function () {
                if (this.hasError) {
                    return this.errors[this.name][0] = null;
                }
            },
...
<style scoped>
    .error-field{
        @apply .border-red-500 .border-t-2
    }
</style>
