    ...
    <div>
        ...
        <div v-else>
            <div class="flex justify-between">
                ...
                <div class="relative">
                    <router-link :to="'/contact/' + contact.contact_id + '/edit'" class="px-4 py-2 rounded text-green-500 border border-green-500 text-sm font-bold mr-2">Edit</router-link>
            ...
            <p class="pt-6 text-gray-600 uppercase text-sm">Contact</p>
            <p>{{ contact.name }}</p>

            <p class="pt-6 text-gray-600 uppercase text-sm">Company</p>
            <p>{{ contact.company }}</p>

            <p class="pt-6 text-gray-600 uppercase text-sm">Birthday</p>
